...
// }
    ...
    handleClick() {
            ...
            console.log('present Address----' + this.personalInfoRecord.permananentAddress);
            console.log('Email is---' + this.personalInfoRecord.email);
            console.log('contact Number---' + this.personalInfoRecord.contactNumber);
            console.log('alt Contact Number----' + this.personalInfoRecord.altContactNumber);
            console.log('whatsapp Number----' + this.personalInfoRecord.whatsappNumber);
            console.log('parentContactNumber----' + this.personalInfoRecord.parentContactNumber);
            ...
            console.log('Entered record-----' + JSON.stringify(this.personalInfoRecord));
